...
""" Contruct a grammar that parses references/citations to the United States Code, 
the Code of Federal Regulations, Public Law and Statues at Large. """
...
public_law_exp = Literal("Public") + Literal("Law") + Word(string.digits) + '-' + Word(string.digits)
