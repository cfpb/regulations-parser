...
class NoticeHistoryTests(TestCase):
    ...
    def test_modify_effective_dates(self):
        outdated = {'document_number': 'outdated',
                    ...
                    'meta': {
                        'volume': 12, 'start_page': 500, 'end_page': 600,
                        'type': 'Rule',
        ...
        unaltered = {   'document_number': 'unaltered',
                        ...
                        'meta': {
                            'volume': 12, 'start_page': 800, 'end_page': 900,
                            'type': 'Rule',
        ...
        proposal = {'document_number': 'proposal',
                    ...
                    'meta': {
                        'volume': 12, 'start_page': 1100, 'end_page': 1200,
                        'type': 'Proposed Rule',
                        'dates': 'We are thinking about delaying the ' +
                            'effective date of 12 FR 501 to March 3, 2003'
                    }}
        changer = { 'document_number': 'changer',
                    'publication_date': '2000-12-31',
                    'effective_on': '2000-12-31',
                    'meta': {
                        'volume': 12, 'start_page': 9000, 'end_page': 9005,
                        'type': 'Rule',
    ...
    def test_overlaps_with(self):
        fr = Notice(10, 225)
        def meta(volume, start, end):
            return {'meta': 
                {'volume': volume, 'start_page': start, 'end_page': end}
            }
    ...
    def test_altered_frs(self):
        ...
        self.assertEqual(altered_frs(sent),
                ([Notice(12, 501), Notice(13, 999), Notice(13, 764)], None))
